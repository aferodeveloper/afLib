...
// Only needed if using UART
// For Uno and UART you will need to connect the UART pins on the Modulo board to these
// pins on the Plinto board, the Plinto doesn't make these connections
...
// Define your MCU pins here that are connected to the ASR and delete the above #error to use your own board
#define RESET                     XX
// Only needed if using SPI
#define INT_PIN                   XX    // Modulo sends an interrupt on this pin to initiate communication
#define CS_PIN                    XX
// Only needed if using UART
#define RX_PIN                    XX    // Connect to Modulo UART_TX
#define TX_PIN                    XX    // Connect to Modulo UART_RX
#endif
